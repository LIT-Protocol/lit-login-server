...
export function bindLogin(handleLogin) {
...
export function bindLogout(handleLogout) {
	const logoutButton = document.getElementById('logout');
	if (logoutButton) {
		logoutButton.addEventListener('click', handleLogout);
		logoutButton.classList.remove('button--disabled');
		logoutButton.disabled = false;
	}
}

export function bindLitAuthEvents(litAuthClient) {
...
function signInUI() {
	document.getElementById('app').innerHTML = `
		<svg class="emoji" viewBox="0 0 72 72" version="1.1" xmlns="http://www.w3.org/2000/svg">
			<g id="color">
		...
		<p class="body">Your adventure awaits!</p>
...
function loadingUI() {
	document.getElementById('app').innerHTML = `
		<div class="img img--loading">
			...
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="48" height="48" stroke-width="1" stroke="currentColor" class="img__icon">
				<path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1121.75 8.25z" />
			</svg>
		</div>
		<h1 class="title">Signing in</h1>
		<p class="body">Checking your credentials...</p>`
}
...
function mintingUI() {
	document.getElementById('app').innerHTML = `
		...
		<h1 class="title">Minting</h1>
		<p class="body">Creating your cloud wallet...</p>`
}
...
function pollingUI() {
	document.getElementById('app').innerHTML = `
		...
		<p class="body">Preparing your new cloud wallet...</p>`
}

function creatingSessionUI() {
	document.getElementById('app').innerHTML = `
		<div class="img img--loading">
			<div class="img__bg"></div>
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="48" height="48" stroke-width="1" stroke="currentColor" class="img__icon">
		...
		<h1 class="title">Finalizing</h1>
		<p class="body">Saving your session...</p>`
}
...
function loggedInUI() {
	...
	document.getElementById('app').innerHTML = `
		...
		<h1 class="title">gm!</h1>
		<p class="body">Signed in as ${session.currentPKP.ethAddress}</p>
		<div class="buttonWrapper">
			<button
				id="logout"
				class="button button--primary button--disabled"
...
function errorUI() {
	document.getElementById('app').innerHTML = `
		...
		<p class="body">Couldn't sign you in. Please try again.</p>
		<div class="buttonWrapper">
			<a class="button button--primary" href="${window.location.origin}">
				Return home
			</a>
		</div>`
}